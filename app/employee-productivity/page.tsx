...
const cards3: {
...
}[] = [
  {
    ...
    imageSrc: "/images/employee-productivity/2.jpg",
  ...
  },
  {
    ...
    imageSrc: "/images/employee-productivity/3.jpg",
  ...
  },
  {
    ...
    imageSrc: "/images/employee-productivity/4.jpg",
...
const imageWithText = [
  {
    ...
    imagePosition: "left",
    videoSrc:"/images/employee-productivity/v1.mp4",
    iconListItems: [
      {
        iconSrc: "/monitor.png",
  ...
  },
  {
    ...
    imagePosition: "right",
    videoSrc:"/images/employee-productivity/v2.mp4",
    iconListItems: [
      {
        iconSrc: "/monitor.png",
  ...
  },
  {
    ...
    imagePosition: "left",
    videoSrc:"/images/employee-productivity/v3.mp4",
    iconListItems: [
      {
        iconSrc: "/monitor.png",
        iconAlt: "Lock Icon",
...
export default function EmployeeProductivityPage() {
  return (
    <div>
      <Banner
        mediaType="video"
        mediaSrc="/images/employee-productivity/banner.mp4"
      ...
      <ImageTextSection
        ...
        imageSrc="/images/employee-productivity/1-1.png"
        ...
        {cards.map((card,i) => (
          <div key={i} className="relative w-[24rem] h-[24rem] flex justify-center items-center">
            ...
            <div
              ...
              className={` h-72 w-72 bg-white border-8 rounded-2xl absolute bottom-0 right-0 z-0 `}
            ></div>
          </div>
        ))}
      </div>
