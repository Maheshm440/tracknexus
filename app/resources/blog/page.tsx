...
const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&h=600&fit=crop"
...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-gray-50 to-white py-10 lg:py-16">
